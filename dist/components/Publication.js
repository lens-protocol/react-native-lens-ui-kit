...
export function Publication(_a) {
    var publication = _a.publication, _b = _a.signedInUser, signedInUser = _b === void 0 ? null : _b, _c = _a.onCollectPress, onCollectPress = _c === void 0 ? function (publication) { return console.log({ publication: publication }); } : _c, _d = _a.onCommentPress, onCommentPress = _d === void 0 ? function (publication) { return console.log({ publication: publication }); } : _d, _e = _a.onMirrorPress, onMirrorPress = _e === void 0 ? function (publication) { return console.log({ publication: publication }); } : _e, _f = _a.onLikePress, onLikePress = _f === void 0 ? function (publication) { return console.log({ publication: publication }); } : _f, _g = _a.onProfileImagePress, onProfileImagePress = _g === void 0 ? function (publication) { return console.log({ publication: publication }); } : _g, _h = _a.hideLikes, hideLikes = _h === void 0 ? false : _h, _j = _a.hideComments, hideComments = _j === void 0 ? false : _j, _k = _a.hideMirrors, hideMirrors = _k === void 0 ? false : _k, _l = _a.hideCollects, hideCollects = _l === void 0 ? false : _l;
